...
const productData: ProductCategory[] = [
	{
		...
		brands: [
			...
			{
				name: "PUFFMI",
				models: ["Dura 9000", "Immortal 16000", "Dura 18000", "Tank 20000"],
			},
			{
				name: "VOZOL",
			...
			{
				name: "ДРУГИЕ БРЕНДЫ",
				models: ["DUALL Bar 12000", "SNOOPYSMOKE 15000", "LOSTVAPE TB18000"],
			},
		],
	},
	{
		...
		brands: [
			...
			{
				name: "RELL",
				models: ["Gray", "Orange", "Ultima", "Azure"],
			},
			{
				name: "HUSKY",
	...
	},
	{
		...
		brands: [
			...
			{
				name: "СНЕКИ",
				models: ["Pringles", "Maltesers", "Toxic Waste", "Shock"],
			},
		],
	},
	{
