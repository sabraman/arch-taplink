...
// Custom SVG for 2GIS
const GisIcon = () => (
	<svg width="24" height="24" viewBox="0 0 565 586" fill="currentColor" aria-hidden="true">
...
const YandexMapIcon = () => (
	<svg width="24" height="24" viewBox="0 0 307 384" fill="currentColor" aria-hidden="true">
